            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="doctorss.php" method="post" class="header-search">
                    ...
                    <td colspan="4">
                        <table width="100%" border="0" class="dashbord-tables">
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="schedules.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Show all Sessions</button></a>
                                    </center>
                                </td>
                            </tr>
                        </table>
